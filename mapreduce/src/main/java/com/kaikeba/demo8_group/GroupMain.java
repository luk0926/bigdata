...
public class GroupMain extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        TextInputFormat.addInputPath(job, new Path("E:\\开课吧\\08_hadoop\\1202_课前资料_mr与yarn\\3、第三天\\9、mapreduce当中的分组求topN\\数据"));
        ...
        TextOutputFormat.setOutputPath(job, new Path("E:\\开课吧\\08_hadoop\\1202_课前资料_mr与yarn\\3、第三天\\9、mapreduce当中的分组求topN\\out"));
